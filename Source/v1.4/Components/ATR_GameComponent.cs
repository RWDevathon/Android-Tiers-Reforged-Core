...
namespace ATReforged
{
    public class ATR_GameComponent : GameComponent
    {
        ...
        {
            ChangeServerPoints(cachedSkillGeneration, ATR_ServerType.SkillServer);
            ChangeServerPoints(cachedSecurityGeneration, ATR_ServerType.SecurityServer);
            ChangeServerPoints(cachedHackingGeneration, ATR_ServerType.HackingServer);
        }
        ...
        public void ResetServers(ATR_ServerType type)
        {
        ...
        {
            ResetServers(ATR_ServerType.SkillServer);
            ResetServers(ATR_ServerType.SecurityServer);
            ResetServers(ATR_ServerType.HackingServer);
        }

        public float GetPointCapacity(ATR_ServerType pointMode)
        {
            switch (pointMode)
            {
                case ATR_ServerType.SkillServer:
        ...
        public float GetPoints(ATR_ServerType pointMode)
        {
            switch (pointMode)
            {
                case ATR_ServerType.SkillServer:
        ...
        public void AddServer(Building building, ATR_ServerType serverMode)
        { 
            switch (serverMode)
            {
                case ATR_ServerType.SkillServer:
        ...
        public void RemoveServer(Building building, ATR_ServerType serverMode)
        {
            switch (serverMode)
            {
                case ATR_ServerType.SkillServer: // Remove from skill servers list.
                    ...
                    break;
                case ATR_ServerType.SecurityServer: // Remove from security servers list.
                    ...
                    break;
                case ATR_ServerType.HackingServer: // Remove from hacking servers list.
                    ...
                    break;
                default:
                    Log.Error("[ATR] ATR_GC.RemoveServer was given an invalid ATR_ServerType. All servers recached.");
                    ResetServers();
                    return;
            }
        }
        ...
        public void ChangeServerPoints(float toChange, ATR_ServerType serverMode)
        {
            switch (serverMode)
            {
