    ...
    public class CompSuperComputer : ThingComp
    {
        ...
        public override string CompInspectStringExtra()
        {
            ...
            ret.AppendLine("ATR_SkillServersSynthesis".Translate(Utils.gameComp.GetPoints(ATR_ServerType.SkillServer), Utils.gameComp.GetPointCapacity(ATR_ServerType.SkillServer)))
               .AppendLine("ATR_SecurityServersSynthesis".Translate(Utils.gameComp.GetPoints(ATR_ServerType.SecurityServer), Utils.gameComp.GetPointCapacity(ATR_ServerType.SecurityServer)))
               .AppendLine("ATR_HackingServersSynthesis".Translate(Utils.gameComp.GetPoints(ATR_ServerType.HackingServer), Utils.gameComp.GetPointCapacity(ATR_ServerType.HackingServer)))
