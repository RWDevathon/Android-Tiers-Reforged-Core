    ...
    public class JobDriver_GenerateInsight : JobDriver
    {
        ...
        protected override IEnumerable<Toil> MakeNewToils()
        {
            ...
            generateInsight.tickAction = delegate
            {
                ...
                Utils.gameComp.ChangeServerPoints(pointsGenerated, CompInsightBench.ATR_ServerType);
            ...
            generateInsight.FailOn(() => Utils.gameComp.GetPointCapacity(CompInsightBench.ATR_ServerType) <= Utils.gameComp.GetPoints(CompInsightBench.ATR_ServerType));
            ...
            generateInsight.WithProgressBar(TargetIndex.A, () => Utils.gameComp.GetPoints(CompInsightBench.ATR_ServerType) / Utils.gameComp.GetPointCapacity(CompInsightBench.ATR_ServerType));
